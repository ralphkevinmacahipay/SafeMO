...
class FakeReport extends StatefulWidget {
  const FakeReport({super.key});

  @override
  State<FakeReport> createState() => _FakeReportState();
}

class _FakeReportState extends State<FakeReport> {
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: const [
                          ...
                          SizedBox(
                              width: 150, child: Text("Fake Report Count")),
